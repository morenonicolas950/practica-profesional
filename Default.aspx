<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Default.aspx.cs" Inherits="PP2024_V10._Default" %>
      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox TextMode="Number" CssClass="form-control" ID="txtEdad" runat="server" />
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox TextMode="Password" CssClass="form-control" ID="txtRepPass" runat="server" />
                </td>
                <td>
                    <asp:RequiredFieldValidator ErrorMessage="Debe ingresar contraseña" ID="RequiredFieldValidator1" ControlToValidate="txtPass" runat="server" Text="*" ForeColor="Red"/>
                    <asp:RequiredFieldValidator ErrorMessage="Debe repetir contraseña" ID="RequiredFieldValidator2" ControlToValidate="txtRepPass" runat="server" Text="*" ForeColor="Red"/>
                    <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Las contraseñas deben ser iguales" ControlToValidate="txtPass" ControlToCompare="txtRepPass" Text="*" ForeColor="Red"></asp:CompareValidator>
                </td>
            </tr>
            <tr>
                <td colspan="2">
